...
class DQNAgent():
    def __init__(self, input_shape, action_size, seed, device, buffer_size, batch_size, gamma, lr, tau, update_every, replay_after, model,arq):
        ...
        # Q-Network
        self.policy_net = self.DQN(input_shape, action_size, "", "policy_DQN",arq).to(self.device)
        self.target_net = self.DQN(input_shape, action_size, "", "target_DQN",arq).to(self.device)
