...
def select_parents(population, scores, num_parents):
    ...
    for _ in range(num_parents):
        ...
        parents.append(population[max_score_idx])
        scores[max_score_idx] = -1  # Para no seleccionarlo nuevamente
    return parents
...
initial_mutation_power = 0.5  # Tasa de mutación más alta al principio
